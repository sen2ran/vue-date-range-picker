          ...
          <div class="datepicker__month" v-for="n in [0,1]" v-bind:key="n">
            ...
            <div class="datepicker__week-row -hide-up-to-tablet">
              <div
                ...
                v-for="(dayName,i) in i18n['day-names']"
                :key="i"
                v-text="dayName"
              ></div>
            </div>
...
// $desktop: "(min-width: 768px)";
// $up-to-tablet:"(min-width: 768px)";
// $extra-small-screen: "(min-width: 768px)";
...
.datepicker {
  ...
  &__wrapper {
    ...
    width: 100%;
    height: 48px;
    background: $white no-repeat 17px center / 16px;
  }
  ...
  &__input {
    ...
    &:first-child {
      background: transparent no-repeat right center / 8px;
      width: calc(50% - 4px);
      text-indent: 20px;
    }
  ...
  &__month-button {
    background: transparent no-repeat center center / 8px;
    cursor: pointer;
    display: inline-block;
    height: 60px;
    width: 60px;
